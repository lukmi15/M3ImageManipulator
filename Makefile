...
# Project:  Editor.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Editor.pro
#############################################################################
...
DISTDIR = /home/lukmi/proj/master/s1/m3-prog-qt/proj/src/.tmp/Editor1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Editor.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = Editor
DESTDIR       = 
TARGET        = Editor
...
Editor: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Editor.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
install_target: first FORCE
	...
	-$(STRIP) $(INSTALL_ROOT)/opt/Editor/bin/$(QMAKE_TARGET)
